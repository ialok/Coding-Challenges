...
"""Script to monitor a service running over HTTP
    
    Example: python MonitorService.py  >/dev/null 2>&1 < /dev/null &
"""
...
class MonitorService(object):
    ...
    def _check_http_response(self, service):
        """
            Args:
                service: dictionary containing service parameters
            Reurns:
                tuple containing the state of the service
        """
        try:
